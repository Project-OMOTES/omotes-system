...
def upgrade() -> None:
    ...
    sa.Column('work_flow_type', sa.Enum('GROWTH_OPTIMIZER', name='workflowtype'), nullable=False),
    sa.Column('user_name', sa.String(), nullable=True),
    sa.Column('project_name', sa.String(), nullable=True),
    sa.Column('status', sa.Enum('REGISTERED', 'RUNNING', 'FINISHED', 'ERROR', 'STOPPED', name='jobstatus'), nullable=False),
